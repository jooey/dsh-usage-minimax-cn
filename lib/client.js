...
const MARQUEE_STYLE_ID = "minimax-usage-marquee-style";
...
style.textContent = [
"@keyframes minimaxUsageMarquee {",
"  0%, 10% { transform: translateX(0); }",
"  90%, 100% { transform: translateX(var(--marquee-shift, -100%)); }",
"}",
".minimax-usage-marquee:hover .minimax-usage-marquee-track {",
"  animation: minimaxUsageMarquee 9s linear infinite;",
"}"
].join("\n");
...
descriptors: [
{
  ...
  create: () => minimaxUsageSnapshotResult$schema
  },
 ...
 * page on click. When the content is wider than the chip, hovering scrolls
 * it marquee-style so the tail stays readable; the full text is always in
 * the title tooltip.
 */
...
const clip = el.querySelector(".minimax-usage-marquee-clip");
const track = el.querySelector(".minimax-usage-marquee-track");
...
measure();
const el = chipRef.current;
const clip = el ? el.querySelector(".minimax-usage-marquee-clip") : null;
...
className: "minimax-usage-marquee",
style: {
  display: "inline-flex",
  alignItems: "center",
  gap: "6px",
...
key: "clip",
className: "minimax-usage-marquee-clip",
style: {
...
React.createElement("span", {
key: "track",
className: "minimax-usage-marquee-track",
style: {
  display: "inline-flex",
  alignItems: "center",
  gap: "6px",
